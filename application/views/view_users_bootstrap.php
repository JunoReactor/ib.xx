...
?> 
<!----><p><small>Выбрано позиций: <?=$count?></small></p>
...
?> 
        ...
        <table width="100%" class="table table-striped">
            <tr>
                <td rowspan="6" class="user-photo" width="190">
                ...
                <td>
                    <a href="?<?=CONTROLLER?>/get/<?=$row['ID']?>" rel="tooltip" data-toggle="tooltip" title="Перейти на странцу с подробной информацией о пользователе..."><h4><?=$row['FullName']?></h4></a>
                </td>
            </tr><tr>    
                <td><a href="?users/departments/<?=$row['DeptID']?>"><?=$row['Dept']?></a>&nbsp;</td>
            </tr><tr>    
                <td><?=$row['Position']?>&nbsp;</td>
            </tr><tr>    
                <td>
                    ...
                    <p class="pull-right text-warning"><small>Текущее местоположение</small></p>
                    <div class="clearfix"></div>
...
<div class="row">
  <div class="col-xs-6">
                    <form role="form" action="/?lookout/get/<?=$row['ID']?>" target="_blank" method="POST" enctype="multipart/form-data">
                      <button type="submit" class="btn btn-success btn-block">Приход</button>
  ...
  <div class="col-xs-6">
                    <form role="form" action="/?lookout/get/<?=$row['ID']?>" target="_blank" method="POST" enctype="multipart/form-data">
                      <button type="submit" class="btn btn-danger btn-block">Уход</button>
                      <input type="hidden" name="TA_TYPE" value="2">
                    </form>
  </div>
</div>
