...
?> 
        ...
        <table width="100%" class="table table-striped">
            ...
            <!--<tr>
                <td>
                        <p>После нажатия будет автоматически выставлена текущая дата и вермя.</p>
                        <form role="form" action="/?lookout/get/<?=$row['ID']?>" method="POST" enctype="multipart/form-data">
                          <button type="submit" class="btn btn-success btn-block">Пришел</button>
                          <input type="hidden" name="TA_TYPE" value="1">
                        </form>
                        <form role="form" action="/?lookout/get/<?=$row['ID']?>" method="POST" enctype="multipart/form-data">
                          <button type="submit" class="btn btn-danger btn-block">Ушел</button>
